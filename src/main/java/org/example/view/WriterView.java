...
public class WriterView {
    ...
    public void createWriter(){
        ...
        Writer newWriter = writerController.createWriter(firstname, lastname, posts, postStatus);
    ...
    public void updateWriter(){
        ...
        Writer updateWriter = writerController.updateWriter(id, firstname, lastname, posts, postStatus);
