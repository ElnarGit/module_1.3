...
public class PostView {
    ...
    private void createPost(){
        ...
        Post newPost = postController.createWriter(content, created, updated, labels, postStatus);
    ...
    public void updatePost(){
        ...
        Post updatePost = postController.updatePost(id, content, created, updated, labels, postStatus);
